...
for(irmst_estimand in irmst_estimand_vec){
 ...
 #irmst_estimand <- "irmst1"
      ...
      plot1 <- readRDS(paste0("plots/two_arm/forest_", irmst_estimand, "_model", 1, ".rds"))
      plot2 <- readRDS(paste0("plots/two_arm/forest_", irmst_estimand, "_model", 2, ".rds"))
      plot3 <- readRDS(paste0("plots/two_arm/forest_", irmst_estimand, "_model", 3, ".rds"))
      #plot1
      # plot2
      #plot3
      ...
      tiff(file = paste0("plots/two_arm/forest_", irmst_estimand, ".tiff"),   
           width = 6.5, 
           height = 4.8,
           units = 'in',  
           res = 300, 
      ...
      print(paste0("plots/two_arm/forest_", irmst_estimand, ".tiff"))
...
for(irmst_estimand in irmst_estimand_vec){
  ...
  for(j in 1:3){
    ...
    forest_plot
    saveRDS(forest_plot, paste0("plots/two_arm/forest_", irmst_estimand, "_model", j, "_cond.rds"))
  ...
  plot1 <- readRDS(paste0("plots/two_arm/forest_", irmst_estimand, "_model", 1, "_cond.rds"))
  plot2 <- readRDS(paste0("plots/two_arm/forest_", irmst_estimand, "_model", 2, "_cond.rds"))
  plot3 <- readRDS(paste0("plots/two_arm/forest_", irmst_estimand, "_model", 3, "_cond.rds"))
  #plot1
  # plot2
  #plot3
  ...
  tiff(file = paste0("plots/two_arm/forest_", irmst_estimand, "_cond.tiff"),   
       width = 6.5, 
       height = 4.8,
       units = 'in',  
       res = 300, 
  ...
  print(paste0("plots/two_arm/forest_", irmst_estimand, "_cond.tiff"))
