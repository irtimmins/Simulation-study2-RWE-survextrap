...
# Two arm primary analyses.
scenarios_analysis2 <- scenarios_all %>%
...
# Single arm sensitivity analysis on stan fit method.
scenarios_analysis3 <- scenarios_all %>%
  filter(design_id == "single_arm",
         mspline_df == 10,
         data_cut_model_id == "data_cut_mod2",
         add_knots %in% c("none", "extra_knots1"),
...
# Single arm sensitivity analysis on df and knot positions.
scenarios_analysis4 <- scenarios_all %>%
  filter(design_id == "single_arm",
         stan_fit_method == "mcmc",
         data_cut_model_id == "data_cut_mod2",
...
# Two arm sensitivity analysis on stan fit method.
scenarios_analysis5 <- scenarios_all %>%
  filter(design_id == "two_arm",
...
# Two arm sensitivity analysis on df and knot positions.
scenarios_analysis6 <- scenarios_all %>%
  filter(design_id == "two_arm",
         weibull_model_id == "weibull_mod1",
         stan_fit_method == "mcmc",
         data_cut_model_id == "data_cut_mod2",
...
scenarios_analysis7 <- scenarios_all %>%
  filter(design_id == "single_arm",
         stan_fit_method == "mcmc",
         mspline_df == 10,
         add_knots %in% c("none", "extra_knots1"),
...
scenarios_analysis_all <- bind_rows(scenarios_analysis1,
                          scenarios_analysis2,
                          scenarios_analysis3,
                          scenarios_analysis4,
                          scenarios_analysis5,
